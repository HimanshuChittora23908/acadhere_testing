              ...
              <div key={item.id}>
                <div className="card3">
                  <div className="card3-body">
                    ...
                    <h3 className="card3-title font-weight-bold">
                      {item.title}
                    </h3>
                    <h5 className="card3-text">
                      <AutoLinkText text={item.text} />
                    </h5>
                    <div className="button_bg1">
                      <button className="hover_button_classroom">
                        <a href={item.alternateLink} className="announcement_a">
                          <span></span>
                          <span></span>
                          <span></span>
                          <span></span>
                          <img src={google} className="google"></img> Classroom
                        </a>
                      </button>
                    </div>
                  </div>
